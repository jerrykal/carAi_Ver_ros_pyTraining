...
class AiNode(Node):
    def __init__(self):
        ...
        self.subsvriber_ = self.create_subscription(String, "ros2Ai", self.receive_data_from_ros, 10)
...
class Env(Environment):
    ...
    def check_termination(self, state):
        ...
        print(state.min_lidar_direction)
...
def main(mode):
    ...
    chpt_dir_load = os.path.join(os.path.dirname(__file__),  'Model', 'DDPG', '0809_car/model') #0623_car_to_target_slow_retrain_double_prev_wheel_d_05 0621_car_to_target_slow_retrain_double_prev_wheel_d_05 0613_car_to_target_slow_retrain_double_prev:5000 0601_car_to_target_test_1
    ...
    try:
        ...
        if mode == 'train':
            ...
            for i in range(load_step+1, load_step+epoch+1):
                ...
                while (not done):
                    ai_action = agent.choose_actions(state, prev_pos, trail_original_pos, inference=noice)
